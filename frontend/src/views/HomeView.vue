<template>
  <div>
    ...
    <div class="row g-2">
      <div v-for="(track, index) in tracks" :key="track.id" class="col-12 col-sm-6 col-md-4 col-lg-3">
        <div class="card text-light" :class="{
          'bg-primary border-primary shadow': player.currentIndex === index
        }">
          ...
          <div class="card-body p-2">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <!-- Play -->
                <button class="btn text-light btn-sm" @click="player.playFromQueue(index)">
                  <i :class="player.currentIndex === index && player.playing
                    ? 'bi bi-pause-fill'
                    : 'bi bi-play-fill'"></i>
                </button>
